Hi! My name is Christopher. I am a roboticist and cybernetician focused on creating cognitive space robotics. I completed a PhD (Doctorate of Engineering) in Aeronautics and Astronautics at the University of Tokyo, Artificial Intelligence Lab. Prior to that, I completed an Engineering Doctorate (EngD) in Software/System Architecture (Software Technology, Model-Driven Engineering) at the Eindhoven University of Technology. I am currently simulating complex dynamics for autonomous robotic navigation in dynamic safety-critical systems, including Space Station Digital Twins. I specialize in sensor fusion, reinforcement learning, system resilience, and synthetic data generation (e.g., a robot trained with multi-objective reinforcement learning to toggle sensors based on training data from synthetic images with deep learning to make risk-informed decisions). 
...
Recently, I have been extending second-order cybernetics, philosophy (modal logics), and sociotechnical aspects to system-of-systems-level domains (emergence, autopoeisis, sociotechnical debt, resilience). 
